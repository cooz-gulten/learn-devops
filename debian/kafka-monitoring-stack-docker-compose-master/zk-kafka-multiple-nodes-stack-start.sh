...
docker-compose -f "$DIR/zk-kafka-multiple-nodes-stack.yml" -f "$DIR/kafka-ui-multiple.yml" up -d

docker-compose -f "$DIR/zk-kafka-multiple-nodes-stack.yml" -f "$DIR/kafka-ui-multiple.yml" ps
